            ...
            <div class="col-xs-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content row">
                        ...
                        {%if subGames is not null %}
                            {% set i = 1 %}
                            {% for subGameData in subGames %}
                                {% if i%2 == 0 %}
                            ...
                            <li class="col-sm-2 col-xs-3 list-group-item">
                                <select class="status">
                                    {% for key, value in status %}
                                        <option value="{{subGameData.id~"|"~key}}" {% if subGameData.st == key %}selected{% endif %}>{{translate[value]}}</option>
                                    {% endfor %}
                                </select>
                            </li>
                            <li class="col-sm-2 col-xs-2 list-group-item">
                                <a href="{{router.getRewriteUri()~'/detail/'~subGameData.id}}">
                                    <span class="fa fa-search text-danger"></span>
                                </a>
                                |
                                <a href="{{router.getRewriteUri()~'/edit/'~subGameData.id}}">
