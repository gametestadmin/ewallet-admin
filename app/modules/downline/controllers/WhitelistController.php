...
//                }
                ...
                $this->db->commit();
                $this->flash->success('notification_downline_create_whitelist_ip_success');
            } catch (\Exception $e) {
                $this->db->rollback();
...
//            }
            ...
            try {
                ...
                $this->db->commit();
                $this->flash->success('notification_downline_set_whitelist_ip_success');
            } catch (\Exception $e) {
                $this->db->rollback();
                $this->flash->error($e->getMessage());
            }
...
//        }
        ...
        try {
            ...
            $this->db->commit();
            $this->flash->success("notification_downline_remove_whitelist_ip_success");
