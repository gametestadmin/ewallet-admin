...
class StatementGameDailyBak extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSource("statement_game_daily_bak");
    ...
    {
        return 'statement_game_daily_bak';
    }
     ...
     * @return StatementGameDailyBak[]|StatementGameDailyBak|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return StatementGameDailyBak|\Phalcon\Mvc\Model\ResultInterface
     */
